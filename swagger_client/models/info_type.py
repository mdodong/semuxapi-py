...
class InfoType(object):
    ...
    def __init__(self, network=None, capabilities=None, client_id=None, coinbase=None, latest_block_number=None, latest_block_hash=None, active_peers=None, pending_transactions=None):  # noqa: E501
    ...
    @property
    def network(self):
        """Gets the network of this InfoType.  # noqa: E501


        :return: The network of this InfoType.  # noqa: E501
        :rtype: str
        """
    ...
    def network(self, network):
        """Sets the network of this InfoType.


        :param network: The network of this InfoType.  # noqa: E501
        :type: str
        """
        allowed_values = ["MAINNET", "TESTNET", "DEVNET"]  # noqa: E501
    ...
    def capabilities(self):
        """Gets the capabilities of this InfoType.  # noqa: E501


        :return: The capabilities of this InfoType.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def capabilities(self, capabilities):
        """Sets the capabilities of this InfoType.


        :param capabilities: The capabilities of this InfoType.  # noqa: E501
        :type: list[str]
        """
    ...
    def latest_block_hash(self, latest_block_hash):
        ...
        :type: str
        """
        if latest_block_hash is not None and not re.search('^(0x)?[0-9a-fA-F]{64}$', latest_block_hash):  # noqa: E501
            raise ValueError("Invalid value for `latest_block_hash`, must be a follow pattern or equal to `/^(0x)?[0-9a-fA-F]{64}$/`")  # noqa: E501
