...
class SemuxApi(object):
    ...
    def add_node(self, node, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str node: Name of the node in host:port format (required)
    ...
    def broadcast_raw_transaction(self, raw, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str raw: Raw transaction (required)
    ...
    def broadcast_raw_transaction_with_http_info(self, raw, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SendTransactionResponse',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def compose_raw_transaction(self, network, type, fee, nonce, **kwargs):  # noqa: E501
        ...
        :param str value: Transaction value in nano
    ...
    def compose_raw_transaction_with_http_info(self, network, type, fee, nonce, **kwargs):  # noqa: E501
        ...
        if 'to' in params and not re.search('^(0x)?[0-9a-fA-F]+$', params['to']):  # noqa: E501
            raise ValueError("Invalid value for parameter `to` when calling `compose_raw_transaction`, must conform to the pattern `/^(0x)?[0-9a-fA-F]+$/`")  # noqa: E501
    ...
    def get_block_by_hash_with_http_info(self, hash, **kwargs):  # noqa: E501
        ...
        if 'hash' in params and not re.search('^(0x)?[0-9a-fA-F]+$', params['hash']):  # noqa: E501
            raise ValueError("Invalid value for parameter `hash` when calling `get_block_by_hash`, must conform to the pattern `/^(0x)?[0-9a-fA-F]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_transaction_limits(self, type, **kwargs):  # noqa: E501
        ...
        Get minimum fee and maximum size.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def get_validators(self, **kwargs):  # noqa: E501
        ...
        Returns a list of validators.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def get_votes(self, delegate, **kwargs):  # noqa: E501
        ...
        Returns all the votes to a delegate  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
    ...
    def register_delegate(self, _from, fee, data, **kwargs):  # noqa: E501
        """Register delegate  # noqa: E501

        Registers as a delegate  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.register_delegate(_from, fee, data, async=True)
        >>> result = thread.get()

        :param async bool
        :param str _from: Registering address (required)
        :param str fee: Transaction fee (required)
        :param str data: Delegate name (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.register_delegate_with_http_info(_from, fee, data, **kwargs)  # noqa: E501
        else:
            (data) = self.register_delegate_with_http_info(_from, fee, data, **kwargs)  # noqa: E501
            return data

    def register_delegate_with_http_info(self, _from, fee, data, **kwargs):  # noqa: E501
        """Register delegate  # noqa: E501

        Registers as a delegate  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.register_delegate_with_http_info(_from, fee, data, async=True)
        >>> result = thread.get()
        ...
        all_params = ['_from', 'fee', 'data']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('fee' not in params or
                params['fee'] is None):
            raise ValueError("Missing the required parameter `fee` when calling `register_delegate`")  # noqa: E501
    ...
    def sign_message(self, address, message, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str address: Signing address (required)
        :param str message: Message to sign (required)
    ...
    def sign_raw_transaction_with_http_info(self, raw, address, **kwargs):  # noqa: E501
        ...
        if 'address' in params and not re.search('^(0x)?[0-9a-fA-F]+$', params['address']):  # noqa: E501
            raise ValueError("Invalid value for parameter `address` when calling `sign_raw_transaction`, must conform to the pattern `/^(0x)?[0-9a-fA-F]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def transfer(self, _from, to, value, fee, data, **kwargs):  # noqa: E501
        """Transfer coins  # noqa: E501

        Transfers coins to another address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.transfer(_from, to, value, fee, data, async=True)
        >>> result = thread.get()

        :param async bool
        :param str _from: Sending address (required)
        :param str to: Receiving address (required)
        :param str value: Amount of SEM to transfer (required)
        :param str fee: Transaction fee (required)
        :param str data: Transaction data (required)
        :return: DoTransactionResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.transfer_with_http_info(_from, to, value, fee, data, **kwargs)  # noqa: E501
        else:
            (data) = self.transfer_with_http_info(_from, to, value, fee, data, **kwargs)  # noqa: E501
            return data

    def transfer_with_http_info(self, _from, to, value, fee, data, **kwargs):  # noqa: E501
        """Transfer coins  # noqa: E501

        Transfers coins to another address.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.transfer_with_http_info(_from, to, value, fee, data, async=True)
        >>> result = thread.get()
        ...
        all_params = ['_from', 'to', 'value', 'fee', 'data']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('fee' not in params or
                params['fee'] is None):
            raise ValueError("Missing the required parameter `fee` when calling `transfer`")  # noqa: E501
        # verify the required parameter 'data' is set
        if ('data' not in params or
                params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `transfer`")  # noqa: E501
    ...
    def unvote(self, _from, to, value, fee, **kwargs):  # noqa: E501
        """Unvote  # noqa: E501

        Unvotes for a delegate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.unvote(_from, to, value, fee, async=True)
        >>> result = thread.get()

        :param async bool
        :param str _from: Voting address (required)
        :param str to: Delegate address (required)
        :param str value: Vote amount (required)
        :param str fee: Transaction fee (required)
        :return: DoTransactionResponse
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.unvote_with_http_info(_from, to, value, fee, **kwargs)  # noqa: E501
        else:
            (data) = self.unvote_with_http_info(_from, to, value, fee, **kwargs)  # noqa: E501
            return data

    def unvote_with_http_info(self, _from, to, value, fee, **kwargs):  # noqa: E501
        """Unvote  # noqa: E501

        Unvotes for a delegate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.unvote_with_http_info(_from, to, value, fee, async=True)
        >>> result = thread.get()
        ...
        all_params = ['_from', 'to', 'value', 'fee']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('fee' not in params or
                params['fee'] is None):
            raise ValueError("Missing the required parameter `fee` when calling `unvote`")  # noqa: E501
    ...
    def verify_message(self, address, message, signature, **kwargs):  # noqa: E501
        ...
        :param str message: Message (required)
    ...
    def vote(self, _from, to, value, fee, **kwargs):  # noqa: E501
        """Vote  # noqa: E501

        Votes for a delegate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.vote(_from, to, value, fee, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.vote_with_http_info(_from, to, value, fee, **kwargs)  # noqa: E501
        else:
            (data) = self.vote_with_http_info(_from, to, value, fee, **kwargs)  # noqa: E501
            return data

    def vote_with_http_info(self, _from, to, value, fee, **kwargs):  # noqa: E501
        """Vote  # noqa: E501

        Votes for a delegate.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.vote_with_http_info(_from, to, value, fee, async=True)
        >>> result = thread.get()
        ...
        if ('fee' not in params or
                params['fee'] is None):
            raise ValueError("Missing the required parameter `fee` when calling `vote`")  # noqa: E501
